...
public class Zombie {
	...
	public void step() {
		...
		GridPoint pointWhitMostHumans = null;
		int maxCount = -1;
		for(GridCell<Human> cell : gridCells) {
			if ( cell.size() > maxCount ) {
				pointWhitMostHumans = cell.getPoint();
				maxCount = cell.size();
			}
		}
		moveTowards(pointWhitMostHumans);
		infect();
	}
	...
	public void moveTowards(GridPoint pt) {
		...
		if( !pt.equals(grid.getLocation(this)) ) {
			...
			space.moveByVector(this, 1, angle, 0); // turn
			myPoint = space.getLocation(this);
			grid.moveTo(this, (int)myPoint.getX(), (int)myPoint.getY()); // move
